    ...
    <section className="help-content">
      ...
      <div className="help-guide">
        ...
        <section id="faq">
          ...
          <details><summary>페이지를 나가도 작성 내용이 남나요?</summary><p>자동 저장되며, 작성 중에 메인 화면이나 뒤로가기를 누르면 계속 작성하거나 임시 저장 후 이동할 수 있습니다. 저장하지 않고 이동하면 마지막 자동 저장 이후 변경만 사라집니다.</p></details>
