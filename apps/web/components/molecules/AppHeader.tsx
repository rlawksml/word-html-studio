...
export function AppHeader({ studio }: { studio: StudioController }) {
  const { role, requestWorkerAccess, returnToVisitor, logout } = studio;
  return <header className="topbar">
    ...
    <div className="header-actions">
      ...
      {role === "visitor" ? <div className="staff-actions">
        <button className="staff-access" onClick={() => void requestWorkerAccess("input")}>소식 입력</button>
        <button className="staff-access" onClick={() => void requestWorkerAccess("html")}>HTML 편집</button>
