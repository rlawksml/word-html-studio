...
export function StudioFeedback({ studio }: { studio: StudioController }) {
  const {
    ...
    setLeaveTarget, setEditingEntryBlock, login, confirmLeave,
  } = studio;
  return <>
